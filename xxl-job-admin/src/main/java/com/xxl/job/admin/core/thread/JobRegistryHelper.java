                ...
                while (!toStop) {
                    try {
                        ...
                        if (groupList != null && !groupList.isEmpty()) {
                            ...
                            deadTime = deadTime.minusSeconds(RegistryConfig.DEAD_TIMEOUT);
                            List<Integer> ids = XxlJobAdminConfig.getAdminConfig()
                                                                 .getXxlJobRegistryDao()
                                                                 .findDead(RegistryConfig.DEAD_TIMEOUT, Date.from(
                                                                     deadTime.atZone(ZoneId.systemDefault())
                                                                             .toInstant()));
